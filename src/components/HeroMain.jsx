      ...
      <div className=" flex-grow p-10 flex justify-center flex-col">
        ...
        <p className="font-semibold text-white flex items-center">
          <svg
            ...
            class="lucide lucide-mail-icon lucide-mail me-2"
          >
        ...
        <p className="text-gray-300 text-sm mb-6">devera.avygael@gmail.com</p>
        <p className="font-semibold text-white flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="15"
        ...
        <p className="text-gray-300 text-sm mb-6">09123456789</p>
