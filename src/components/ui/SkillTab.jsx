function SkillTab({ skill }) {
    return (
        <div className="group flex items-center duration-300 bg-gradient-to-br from-white to-neutral-200 shadow-sm dark:from-neutral-700 dark:text-gray-200 dark:to-neutral-950 tracking-wide px-4 py-2.5 rounded-md border dark:border-neutral-700 text-xs hover:text-emerald-600 hover:border-emerald-400 dark:hover:text-emerald-400">
            {/* This dot changes color when the parent is hovered */}
